...
const Speaking = () => {
    ...
    const handleCheckButtonClick = () => {
        // Check if inputValue contains a word
    ...
    const handleSpeechRecognition = () => {
        if (!('webkitSpeechRecognition' in window)) {
            alert('Speech recognition is not supported in this browser. Please use a different browser.');
            return;
        }
        ...
        recognition.onresult = (event) => {
            const result = event.results[event.results.length - 1][0].transcript; // Get the latest result
                    ...
                    <div className="quiz-app">
                        ...
                        <div className="options-area">
                            <div className="form-control">
                                ...
                                />
                                <button onClick={recorder}>Recorder</button>
